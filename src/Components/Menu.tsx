  ...
  return (
    <div  className="flex flex-col h-full justify-between ">
      <section id='properties-section' className="w-full  mx-auto px-4 text-xl flex justify-between items-center border-b shadow ">
       ...
       <Link className=" button-alike border-none px-2 flex justify-center items-center my-y" to={'/customizar'}> <h2 className= "" >+</h2> </Link>
      </section>
      <section id="current-day-section" className="h-4/6 shadow w-full p-1" >
        {dayTemplate}
      </section>
      <section id="selection-section" className=' py-2 shadow w-full text-2xl h-2/6 flex flex-col justify-center items-center gap-6  '>
        <h2 className="button-alike w-11/12 rounded-lg text-center" ><Link to={'/tarefas'}> Calendário </Link></h2>
        <h2 className="button-alike w-11/12 rounded-lg text-center" ><Link to={'/recompensas'}> Recompensas  </Link></h2>
